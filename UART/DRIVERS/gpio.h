...
typedef enum{
    GPIO_MODE_INPUT         =   ((uint32_t)0x00U),
    GPIO_MODE_OUTPUT        =   ((uint32_t)0x01U),
    GPIO_MODE_ALT           =   ((uint32_t)0x02U),
    GPIO_MODE_ANALOG        =   ((uint32_t)0x03U),
    
    GPIO_MODE_IT_FALLING    =   ((uint32_t)0x10U),
    GPIO_MODE_IT_RISING     =   ((uint32_t)0x20U),
    GPIO_MODE_IT_BOTH       =   ((uint32_t)0x30U),
}GPIOx_MODE;
...
#define GPIO_RESET                  ((uint32_t)0x3)
/*-------------------------*/
